...
- A **FORMAÇÃO** e a **EVOLUÇÃO** do Direito:
  ...
  - **<u>ESTÃO</u>** subordinados:
    - A uma **REALIDADE SOCIAL** subjacente;
    - À presença de determinados **FATORES**:
      - Que **INFLUENCIAM** fortemente **à própria sociedade**;
      - Que **DEFINEM** as diversas **estruturas da sociedade**;
- A fim de que o **Direito** seja **<u>INSTRUMENTO EFICAZ</u>** ao **BEM-ESTAR** e ao **PROGRESSO SOCIA**L:
  - Deve estar sempre adequado à realidade;
  - Deve refletir as instituições;
  - Deve refletir a vontade coletiva
  - A sua **EVOLUÇÃO** deve expressar um esforço do legislador em realizar a **ADAPTAÇÃO** das **normas** ao **momento histórico**;
- Os **FATORES** que influenciam a **VIDA SOCIAL** (provocando/sendo causa de mutações) vão produzir igual efeito no **SETOR JURÍDICO** determinando **ALTERAÇÕES** no **DIREITO POSITIVO**;
  - Esses fatores, nos casos acima, são **FATORES SOCIAIS** e também **FATORES JURÍDICOS**;
...
<table border="1" id="quadro-definicao-XXXXX">
  <tr>
    ...
    <td valign="top">
     <p style="text-align:center"><b>O QUE SÃO <u>FATORES JURÍDICOS</u> ?</b></p>
     <p>São <b>elementos</b> que condicionam os <b>fenômenos sociais</b> e, <u>em consequência</u>, <b><u>induzem</u> transformações</b> no <b>Direito</b>.</p>
     <p>A Sociologia Jurídica estuda os <b>FATORES JURÍDICOS</b> responsáveil pela criação e evolução das NORMAS JURÍDICAS.</p>
     <p>Há <b>DOIS GRUPOS</b> de <b>FATORES JURÍDICOS</b>?</p>
     <ul>
       <li>Os <b>NATURAIS</b>;</li>
       <li>Os <b>CULTURAIS</b>;</li>
     </ul>
    </td>
  </tr>
</table>

- A **VARIAÇÃO** a que o **Direito** está sujeito <u>**NÃO É**</u> **ILIMITADA** !
- Sofre **REFORMULAÇÕES** **<u>LENTAS</u>** e **<u>EVENTUAIS</u>** os setores do Direito que **já se acham sistematizados**:
